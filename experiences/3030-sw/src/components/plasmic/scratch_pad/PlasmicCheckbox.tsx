...
import sty from './PlasmicCheckbox.module.css'; // plasmic-import: z3VAJYD8UkW/css

import SquaresvgIcon from './icons/PlasmicIcon__Squaresvg'; // plasmic-import: LmnsLcJ4ebU/icon
import SquareCheckFilledsvgIcon from './icons/PlasmicIcon__SquareCheckFilledsvg'; // plasmic-import: 1HLqsAmjGVO/icon
import SquareMinussvgIcon from './icons/PlasmicIcon__SquareMinussvg'; // plasmic-import: fC6Y6K3L3WR/icon

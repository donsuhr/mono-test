...
import sty from './PlasmicButton.module.css'; // plasmic-import: qpNzjgPDkDg/css
      ...
      {(hasVariant($state, 'showStartIcon', 'showStartIcon') ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__lz9Us)}
                role={'img'}
              />
            ),
      ...
      {(hasVariant($state, 'showEndIcon', 'showEndIcon') ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__wEq2Q)}
                role={'img'}
              />
            ),
